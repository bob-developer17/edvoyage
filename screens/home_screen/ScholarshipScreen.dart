...
List<Scholarship> scholarships=List.empty();
  ...
  if (response.statusCode == 200) {
    ...
    String jsonData = response.body;
     ...
     setState(() => scholarships = jsonList.map((json) => Scholarship.fromJson(json)).toList());
...
,
                        ...
                        Column(
                          ...
                          children: [
                            Container(
                              width: MediaQuery.of(context).size.width - 140, // Adjust width according to your layout
                              child: Text(
                                scholarship.title,
                                style: TextStyle(
                                                   fontSize: 15,
                                ...
                                softWrap: true,
                                overflow: TextOverflow.visible, // Adjust overflow behavior
                              ),
                            ),
                          ],
                        ),
