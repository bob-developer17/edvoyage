...
late String universitylocation = '';
late String universitywebsite = '';
late String universityProfileImage = '';
late String universityLogo = '';
late String coursename = '';
late String duration = '';
late String intake = '';
late int grandtotal = 0;
late String neetEligibility = '';
late String ieltsEligibility = '';
late bool passport = false;
late bool ielts = false;
late bool tenthCard = false;
late bool twelfthCard = false;
late bool visa = false;
late String Firstyearfees = '';
late String Secondyearfees = '';
late String Thirdyearfees = '';
late String Fourthyearfees = '';
late String Fifthyearfees = '';
late List<dynamic> Firstyearsubjects = [];
late List<dynamic> Secondyearsubjects = [];
late List<dynamic> Thirdyearsubjects = [];
late List<dynamic> Fourthyearsubjects = [];
late List<dynamic> Fifthyearsubjects = [];
